...
URLCode auth (@jimhoyd/urlcode-auth) is the optional, operator-installed authentication extension for URLCode. It is a maintainer-led
...
CI actions are pinned to immutable revisions. Dependabot proposes npm (runtime and development dependencies) and GitHub Actions updates; updates are reviewed and tested, not
...
URLCode auth is licensed under [Apache-2.0](LICENSE). Contributions follow the terms
